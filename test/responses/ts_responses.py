...
district_match = {'vb.vf_reg_cass_state': 'IL', 'vb.vf_reg_cass_zip': '60622',
			  	  ...
			  	  'voters_in_district': '2', 'z9_latitude': 41.898369, 'z9_longitude':
			  	  -87.694382}
...
district_expected = ['vb.vf_reg_cass_state', 'vb.vf_reg_cass_zip', 'vb.reg_cass_zip4',
...
address_expected = ['vb.vf_reg_cass_state', 'vb.vf_reg_cass_zip', 'vb.reg_cass_zip4', 'vb.vf_precinct_id',
					...
					'statezip5zip4', 'zip5zip4', 'FilteredFirstCut.vb.vf_reg_cass_state', 'FilteredFirstCut.vb.vf_reg_cass_zip',
					'FilteredFirstCut.vb.reg_cass_zip4', 'FilteredFirstCut.vb.vf_precinct_id',
					'FilteredFirstCut.vb.vf_precinct_name', 'FilteredFirstCut.vb.vf_ward',
					'FilteredFirstCut.vb.vf_township', 'FilteredFirstCut.vb.vf_county_code',
					'FilteredFirstCut.vb.vf_county_name', 'FilteredFirstCut.vb.vf_sd', 'FilteredFirstCut.vb.vf_hd',
					'FilteredFirstCut.vb.vf_cd', 'FilteredFirstCut.vb.vf_city_council', 'FilteredFirstCut.vb.vf_municipal_district',
...
zip_expected = ['vb.vf_reg_cass_state', 'vb.vf_reg_cass_zip', 'vb.reg_cass_zip4', 'vb.vf_precinct_id', 'vb.vf_precinct_name',
				'vb.vf_ward', 'vb.vf_township', 'vb.vf_county_code', 'vb.vf_county_name', 'vb.vf_sd', 'vb.vf_hd', 'vb.vf_cd',
				'vb.vf_city_council', 'vb.vf_municipal_district', 'vb.vf_county_council', 'vb.vf_judicial_district',
				'vb.vf_school_district']

### Radius Endpoint ###

radius_response = {'input': {'first_name': 'Billy', 'last_name': 'Blanks',
				   ...
				   'last_name_prefix_length': '10'}, 'error': None,
				   'output': [{'similarity_score': 92, 'data_fields': {'vb.vf_g2014': 'Y',
				   ...
				   'confidence_indicator': 'Excellent Match'}], 'output_size': 1,
...
phone_expected = ['vb.voterid', 'vb.tsmart_full_address', 'vb.voterbase_age', 'vb.tsmart_first_name',
